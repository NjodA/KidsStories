...
function level() {
  ...
  for (let i = 0; i < length; i++) {
    ...
    q.setAttribute("placeholder", "السؤال" +""+ i + 1);
    op1.setAttribute("id", "op1" + i);
    op1.setAttribute("placeholder", "الخيار الأول");
    op2.setAttribute("id", "op2" + i);
    op2.setAttribute("placeholder", "الخيار الثاني");
    op3.setAttribute("id", "op3" + i);
    op3.setAttribute("placeholder", "الخيار الثالث");
    op4.setAttribute("id", "op4" + i);
    op4.setAttribute("placeholder", "الإجابة الصحيحة");
